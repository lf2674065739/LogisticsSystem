		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="demo/${msg }.do" name="demoForm" id="demoForm" method="post">
							
							<div id="zhongxi" style="padding-top: 13px;">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<tr>
									<!--  
									<td style="width:79px;text-align: right;padding-top: 13px;">角色:</td>
									<td id="js">
									<select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="请选择名字" style="vertical-align:top;"  title="级别" style="width:98%;" >
									...
									<td><input class="span10 date-picker" name="START_TIME" id="START_TIME" value="${pd.ID}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="开通日期"  title="开通日期" style="width:98%;" /></td>
								</tr>
								-->
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">编号:</td>
									<td><input type="text" name="NO" id="NO" value="${pd.NO }" placeholder="编号" title="用户名" style="width:98%;" /></td>
									<td style="width:79px;text-align: right;padding-top: 13px;">姓名:</td>
									<td><input type="text" name="NAME" id="NAME" value="${pd.NAME}" type="text"  style="width:98%;" /></td>
								</tr>
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">年龄:</td>
									<td><input type="text" name="AGE" id="AGE" value="${pd.AGE }" maxlength="32" placeholder="这里输入年龄" title="年龄" onblur="hasN('${pd.NAME }')" style="width:98%;" /></td>
									  
									<td style="width:79px;text-align: right;padding-top: 13px;">工资:</td>
									<td><input type="text" name="SAL" id="SAL"  value="${pd.SAL }" maxlength="32" placeholder="这里输入工资" title="工资" onblur="hasE('${pd.NAME }')" style="width:98%;" /></td>
								</tr>
								<!--  
								<tr>
