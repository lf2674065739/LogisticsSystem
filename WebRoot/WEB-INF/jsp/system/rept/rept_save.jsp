		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="rept/${msg }.do" name="reptForm" id="reptForm" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="hidden" name="RECEIVINGPARTYID" id="RECEIVINGPARTYID" value="${pd.RECEIVINGPARTYID}" maxlength="50" placeholder="这里输入英文" title="英文" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">收货单位:</td>
								<td><input type="text" name="RECEIVINGUNIT" id="RECEIVINGUNIT" value="${pd.RECEIVINGUNIT}" maxlength="50" placeholder="这里输入英文" title="英文" style="width:98%;"/></td>
							</tr>
							...
							<tr>
								<td class="center" colspan="10">
									<a class="btn btn-mini btn-primary" onclick="saveK();">保存</a>
