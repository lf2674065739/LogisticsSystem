		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="appUser/${msg }.do" name="appUserForm" id="appUserForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="NAME" id="NAME" maxlength="32" placeholder="这里输入用户名" title="用户名" style="width:98%;"/></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="password" name="SPASSWORD" id="SPASSWORD" maxlength="32" placeholder="这里输入确认密码" title="确认密码" style="width:98%;"/></td>
										</tr>
										<tr>
										    <td style="width:79px;text-align: right;padding-top: 13px;">角色:</td>
											<td id="juese">
										...
										<%-- <tr>
											...
											<td><input type="text" name="AREAID" id="AREAID"  value="${pd.AREAID }"  maxlength="32" placeholder="这里输入区域ID" title="区域ID" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">手机号:</td>
